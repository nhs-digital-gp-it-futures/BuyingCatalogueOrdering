...
Scenario: 2. Verify the price calculations for an order with multiple order items
    Given Order items exist
        ...
        | C000014-01 | Cat Item 2      | Sol2              | AssociatedService   | eu      | New Desc                      | 200     | Patient            | 120        | Year               | NULL          |
    ...
    Examples:
        | CatalogueItemType | ProvisioningType | TimeUnit | Price | Quantity | EstimationPeriod | RecurringPerMonthValue | RecurringPerYearValue |
        | Solution          | OnDemand         | Null     | 0     | 0        | Month            | 2600                   | 31200                 |
        | AssociatedService | OnDemand         | Null     | 1     | 10       | Month            | 2610                   | 31320                 |
        | AdditionalService | Declarative      | Month    | 9000  | 1        | Year             | 11600                  | 139200                |
        | Solution          | Patient          | Year     | 450   | 3        | Month            | 2712.5                 | 32550                 |
        | AssociatedService | Declarative      | NULL     | 125   | 100      | Year             | 2600                   | 31200                 |
