...
# Test passes when run in isolation (intermittent failure when run as part of a test run to investigate)
@ignore
@6739
Scenario: a user can create an order and data is persisted to the database
    ...
    And the order is created in the database with ID 10001 and data
        ...
        | 10001 | This is an order for organisation 2 | Incomplete  | 4af62b99-638c-4247-875e-965239cd0c48 | 7b195137-6a59-4854-b118-62b39a3101ef | Bob Smith         |
...
Scenario: a user creates an order when existing orders are present, the order is created with a incremented order ID
    ...
    And the order is created in the database with ID 10002 and data
        | Id     | Description                         | OrderStatus | OrderingPartyId                      | LastUpdatedBy                        | LastUpdatedByName |
        | 10002  | This is an order for organisation 2 | Incomplete  | 4af62b99-638c-4247-875e-965239cd0c48 | 7b195137-6a59-4854-b118-62b39a3101ef | Bob Smith         |
...
# Error in pipeline to investigate (passes in VS)
@ignore
@6739
