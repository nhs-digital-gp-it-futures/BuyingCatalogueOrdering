...
Scenario: create catalogue solution order item with a missing or invalid field
    ...
    Examples: request payloads
        ...
        | Item A                   | Solution          | NULL                | GBP          | month            | patient                 | #A string of length 41# | 10.50            | Patient          | month                   | per month               | flat    | ItemUnitDescriptionTooLong                 | ItemUnit.Description |
...
Scenario: create additional service order item with a missing or invalid field
    ...
    Examples: request payloads
        ...
        | Item A                   | AdditionalService | 1000-001                | GBP          | month            | patient                 | #A string of length 41# | 10.50            | Patient          | month                   | per month               | flat    | ItemUnitDescriptionTooLong                 | ItemUnit.Description |
...
Scenario: create associated service order item with a missing or invalid field
    ...
    Examples: request payloads
        ...
        | Item A                   | AssociatedService | NULL                | GBP          | month            | patient                 | #A string of length 41# | 10.50            | Patient          | month                   | per month               | flat    | ItemUnitDescriptionTooLong                 | ItemUnit.Description |
