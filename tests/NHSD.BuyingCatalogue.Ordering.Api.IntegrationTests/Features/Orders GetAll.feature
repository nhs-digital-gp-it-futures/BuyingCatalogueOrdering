...
Background:
    Given Orders exist
        | OrderId    | Description               | OrderStatus | IsDeleted | Created    | LastUpdated | LastUpdatedByName | LastUpdatedBy                        | OrganisationId                       | Completed  |
        | C000014-01 | Some Description          | Complete    |           | 11/05/2020 | 11/05/2020  | Bob Smith         | 335392e4-4bb1-413b-9de5-36a85c9c0422 | 4af62b99-638c-4247-875e-965239cd0c48 | 11/05/2020 |
        | C000014-02 | Another Description       | Incomplete  |           | 05/05/2020 | 09/05/2020  | Alice Smith       | a11a46f9-ce6f-448a-95c2-fde6e61c804a | 4af62b99-638c-4247-875e-965239cd0c48 |            |
        | C000014-03 | One more Description      | Incomplete  |           | 15/05/2020 | 19/05/2020  | Alice Smith       | a11a46f9-ce6f-448a-95c2-fde6e61c804a | e6ea864e-ef1b-41aa-a4d5-04fc6fce0933 |            |
        | C000014-04 | Deleted Order description | Incomplete  | true      | 05/05/2020 | 09/05/2020  | Alice Smith       | a11a46f9-ce6f-448a-95c2-fde6e61c804a | 4af62b99-638c-4247-875e-965239cd0c48 |            |
...
Scenario: 1. Get all of the orders from an existing organisationId excludes deleted orders
    ...
    And the orders list is returned with the following values
        | OrderId    | Description         | Status     | Created    | LastUpdated | LastUpdatedByName | Completed  |
        | C000014-01 | Some Description    | Complete   | 11/05/2020 | 11/05/2020  | Bob Smith         | 11/05/2020 |
        | C000014-02 | Another Description | Incomplete | 05/05/2020 | 09/05/2020  | Alice Smith       |            |
