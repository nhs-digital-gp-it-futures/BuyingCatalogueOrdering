...
Background:
    ...
    Given Order items exist
        ...
        | C000014-02 | Sol 4             | Solution          | eu      | 05/06/2020 |
        | C000014-02 | Add Serv 3        | AdditionalService | eu      | 05/05/2020 |
        | C000014-02 | Ass Serv 2        | AssociatedService | auz     | 12/14/2019 |
...
@5124
Scenario: 2. Get all order items for a deleted order ID filtering by catalogue item type
