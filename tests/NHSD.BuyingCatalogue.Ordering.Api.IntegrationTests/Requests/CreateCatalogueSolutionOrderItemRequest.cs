    ...
    internal sealed class CreateCatalogueSolutionOrderItemRequest : CreateOrderItemBaseRequest
    {
        ...
        protected override IDictionary<string, Func<CreateOrderItemRequestPayload>> PayloadFactory =>
            new Dictionary<string, Func<CreateOrderItemRequestPayload>>()
            {
                ...
                {"missing-catalogue-solution-id", () => CreateOrderItemRequestPayloadBuilder.CreateSolution().WithCatalogueItemId(null).Build()},
                {"missing-catalogue-solution-name", () => CreateOrderItemRequestPayloadBuilder.CreateSolution().WithCatalogueItemName(null).Build()},
                ...
                {"too-long-catalogue-solution-id", () => CreateOrderItemRequestPayloadBuilder.CreateSolution().WithCatalogueItemId(new string('1', 15)).Build()},
                {"too-long-catalogue-solution-name", () => CreateOrderItemRequestPayloadBuilder.CreateSolution().WithCatalogueItemName(new string('1', 256)).Build()},
